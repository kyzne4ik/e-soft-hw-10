# Домашнее задание #8: Knex Query Builder + Prisma ORM
...
> **Цель:** переписать stub-репозитории на Knex. Создать миграции и сиды. Сервер продолжает работать — но данные теперь в PostgreSQL. feature/knex
